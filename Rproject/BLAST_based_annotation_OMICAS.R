...
dir <- "/LUSTRE/bioinformatica_data/genomica_funcional/rgomez/fernando_pub/1_assembly_dir/Folds_200x_dir/FASTA_DIR/transrate_contigs_reference_dir/blast_outputs"
...
outdir <- paste0(getwd(), "/BLAST_based_annotation_dir/PLASS_dir")
